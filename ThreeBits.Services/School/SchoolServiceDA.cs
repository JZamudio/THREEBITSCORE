...
using ThreeBits.Entities.School.Reportes;
...
namespace ThreeBits.Services.School
{
    ...
    public class SchoolServiceDA : SqlDataContext, ISchoolServiceDA
    {
        ...
        {
            var dbCommand = new SqlCommand("proc_LISTA_ALUMNOS")
            {
        ...
        public string fnRegistroAlumnoDat(AlumnosBE item)
        {
            ...
            var dbCommand = new SqlCommand("proc_ALUMNOS")
            {
                CommandType = CommandType.StoredProcedure
                ...
                if (ExecuteReader(ref dbCommand, out DataTable DataTable, out string dbError))
                {
                    foreach (DataRow row in DataTable.Rows)
                    {
                        ...
                        sRespuesta = row["MATRICULA"].ToString();
                        break;
                    }
                }
                else throw new DbDataContextException(dbError);
        ...
        {
            List<AlumnosBE> oAlumnosLista = new List<AlumnosBE>();
            var dbCommand = new SqlCommand("proc_LISTA_ALUMNOS_GRUPO")
            {
                CommandType = CommandType.StoredProcedure
        ...
        {
            List<AlumnosBE> oAlumnosLista = new List<AlumnosBE>();
            var dbCommand = new SqlCommand("proc_LISTA_ALUMNOS_GRUPO_ADD")
            {
                CommandType = CommandType.StoredProcedure
        ...
        {
            AlumnosBE item = new AlumnosBE();
            var dbCommand = new SqlCommand("select a.*, b.* from Alumnos a, InfoAlumnos b where a.NumeroMatricula = b.NumeroMatricula and a.NumeroMatricula = '" + Alumno + "'")
            {
        ...
        {
            AlumnosBE item = new AlumnosBE();
            var dbCommand = new SqlCommand("select NumeroMatricula, idAlumno, Apaterno, Amaterno, Nombres from Alumnos where idAlumno = '" + Alumno + "'")
            {
                CommandType = CommandType.Text
        ...
        public AlumnoDs ObtenerAlumnoRpt(string sMatricula)
        {
            ...
            var dbCommand = new SqlCommand("proc_RPT_ALUMNO")
            {
                CommandType = CommandType.StoredProcedure
        ...
        public List<GradoBE> ObtieneGradoDat(string Nivel)
        {
            ...
            var dbCommand = new SqlCommand("proc_LISTA_GRADO")
            {
                CommandType = CommandType.StoredProcedure
        ...
        public string AsignaAlumnoGrupoDat(string idAlumno, string grupo, string ciclo, string user)
        {
            ...
            var dbCommand = new SqlCommand("proc_ASIGNA_ALUMNO_GRUPO")
            {
                CommandType = CommandType.StoredProcedure
        ...
        {
            List<AlumnosBE> oAlumnosLista = new List<AlumnosBE>();
            var dbCommand = new SqlCommand("select * from alumnos where idColegio=" + idColegio)
            {
                CommandType = CommandType.Text
        ...
        public List<PagosBE> ListaPagosAlumnoDat(string Alumno)
        {
            ...
            var dbCommand = new SqlCommand("proc_LISTA_PAGOS_ALUMNO")
            {
                CommandType = CommandType.StoredProcedure
        ...
        {
            AlumnosBE item = new AlumnosBE();
            var dbCommand = new SqlCommand("select A.idAlumno, A.NumeroMatricula, A.APaterno, A.AMaterno , A.Nombres, " +
        ...
        public RecibosDs ObtenerReciboRpt(string sAlumno)
        {
            ...
            var dbCommand = new SqlCommand("proc_RPT_RECIBO")
            {
                CommandType = CommandType.StoredProcedure
            ...
            var dbCommand2 = new SqlCommand("proc_RPT_RECIBO_ALUMNO")
            {
                CommandType = CommandType.StoredProcedure

            };
            dbCommand.Parameters.Add("IDALUMNO", SqlDbType.VarChar, 50).Value = sAlumno;
            if (ExecuteReader(ref dbCommand2, out DataTable DataTable2, out string dbError2))
            {
                DataTable2.TableName = "dtReciboAlumno";
                dsRecibo.Tables.Add(DataTable2);
            }
            else throw new DbDataContextException(dbError2);
        ...
        public DeudoresDs ObtenerDeudoresRpt()
        {
           DeudoresDs dsDeudores = new DeudoresDs();
            var dbCommand = new SqlCommand("proc_LISTA_DEUDORES")
            {
                CommandType = CommandType.StoredProcedure
        ...
        public CredencialDS ObtenerCredencialesRpt(string Matricula)
        {
            ...
            var dbCommand = new SqlCommand("proc_RPT_CREDENCIAL")
            {
                CommandType = CommandType.StoredProcedure
